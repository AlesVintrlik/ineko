...
Private Sub btnLogin_Click()
    ...
    If VerifyCredentials(userName, password, ServerName, databaseName) Then
        ...
        WriteLog "The application was opened by the user: " & userName
        
        ' Zobraz formuláø s progress barem (modeless)
        frmProgress.Show vbModeless
        frmProgress.UpdateProgressBar 0
        DoEvents
        
        ' Naastavení fontu, formátu datumù a šíøky sloupcù
        ...
        For Each frm In VBA.UserForms
            If frm.Name = "frmProgress" Then
                ...
                ' místo MsgBox zavolej nový formuláø
        ...
        ' Po naètení dat okamžitì zviditelníš Excel
        Application.Visible = True
        Application.WindowState = xlMaximized
        
        ' Aktivace požadovaného listu
